(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '../utils/EventUtils/isValidClick', '../utils/EventUtils/captureNextEvent', '../utils/EventUtils/touches', '../utils/NumberUtils/calcTimeFromPoint', '../utils/calcPageOffset', '../Helpers/ResizeObserver', './ClockTime', './ClockHand'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('../utils/EventUtils/isValidClick'), require('../utils/EventUtils/captureNextEvent'), require('../utils/EventUtils/touches'), require('../utils/NumberUtils/calcTimeFromPoint'), require('../utils/calcPageOffset'), require('../Helpers/ResizeObserver'), require('./ClockTime'), require('./ClockHand'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  var ClockFace = function (_PureComponent) {
    ...
    _createClass(ClockFace, [{
      ...
      value: function _handleTouchStart() {
        ...
        (0, _touches.addTouchEvent)(window, 'end', this._handleTouchEnd);
        this.setState({ moving: true });
      }
    }, {
