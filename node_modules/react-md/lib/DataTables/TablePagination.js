(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', '../utils/getField', '../Helpers/ResizeObserver', '../SelectFields/SelectField', '../Buttons/Button', './findTable'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('../utils/getField'), require('../Helpers/ResizeObserver'), require('../SelectFields/SelectField'), require('../Buttons/Button'), require('./findTable'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.getField, global.ResizeObserver, global.SelectField, global.Button, global.findTable);
    global.TablePagination = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _getField, _ResizeObserver, _SelectField, _Button, _findTable) {
  'use strict';
  ...
  TablePagination = function (_PureComponent) {
    ...
    function TablePagination(props, context) {
      ...
      _this._throttledPosition = function () {
        if (!_this._ticking) {
    ...
    _createClass(TablePagination, [{
      ...
      value: function _setControls(controls) {
        ...
        this._table = (0, _findTable2.default)(controls);
      }
    }, {
      key: '_position',
